...
export default function ContactsTab({ protectedData }) {
  ...
  const [grantedFarms, setGrantedFarms] = useState(null); // This will store your farms data
      ...
      const updatedFarms = await Promise.all(
        contacts.map(async (contact) => {
          ...
          for (const farm of farmsData) {
            ...
            if (farms_addresses && farms_addresses.length > 0) {
  ...
  return (
    <>
      ...
      <Loading isLoading={grantedFarms === null}>
        <Table
